...
if ($('#caja_secundaria').length > 0) {
    ...
    $(document).on('click', '#boton_asignar', function traer_usuarios() {
        ...
        if ( select == '--') {
            ...
            $.ajax({
                ...
                success: function(json) {
                    ...
                    for (var i = 0; i < cargos.length; i++) {
                        $('#segmentar').append('<option value="' + cargos[i][0] + '">' + cargos[i][1] + '</option>');
                    }
            ...
            // $('#segmentar').on('change', function select_perfil() {
            //     var segmentacion = $('#segmentar option:selected').text();
            //
            // });
