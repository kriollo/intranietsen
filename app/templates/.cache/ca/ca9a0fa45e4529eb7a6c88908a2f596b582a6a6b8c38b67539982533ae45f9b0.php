                ...
                <div class=\"box\">
                    ...
                    <div class=\"box-body\">
                        <table class=\"table table-bordered\">
                            ...
                            <tbody>
                                {% set No = 1 %}
                                {% for d in confirma_resumen_x_comuna if false != confirma_resumen_x_comuna %}
                                    <tr>
                                        <td>{{ No }}</td>
                                        <td>{{ d.comuna|raw|title }}</td>
                                        <td>{{ d.cantidad }}</td>
                                    </tr>
                                {% set No =  No + 1 %}
                                {% endfor %}
                ...
                <div class=\"box\">
                    ...
                    <div class=\"box-body\">
                        <table class=\"table table-bordered\">
                            ...
                            <tbody>
                                {% set No = 1 %}
                                {% for d in confirma_top_5_best_ejecutivo if false != confirma_top_5_best_ejecutivo %}
                                    <tr>
                                        <td>{{ No }}</td>
                ...
                <div class=\"box\">
                    ...
                    <div class=\"box-body\">
                        <table class=\"table table-bordered\">
                            ...
                            <tbody>
                                {% set No = 1 %}
                                {% for d in confirma_top_5_bad_ejecutivo if false != confirma_top_5_bad_ejecutivo %}
                                    <tr>
                                        <td>{{ No }}</td>
                                        <td>{{ d.name|raw|title }}</td>
                                        <td>{{ d.cantidad }}</td>
...
{% endblock %}
", "confirmacion/confirmacion.twig", "C:\\xampp\\htdocs\\proyectos\\intranietsen\\app\\templates\\confirmacion\\confirmacion.twig");
    }
}
