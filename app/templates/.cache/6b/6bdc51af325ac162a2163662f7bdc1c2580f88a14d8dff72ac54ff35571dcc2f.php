...
class __TwigTemplate_e0492ce9565bb122b598a14404369e3832b9a434be55497d59ea9cee69206b5e extends Twig_Template
{
...
{% block appBody %}
    <section class=\"content-header\">
        <h1>
            ...
            {% if db_nuevo.id_area >0  %}
                <a class=\"btn btn-primary btn-social pull-right\" href=\"rrhh/ausencias\" title=\"Agregar\" data-toggle=\"tooltip\">
                    <i class=\"fa fa-plus\"></i> Agregar Nueva Ausencia
                </a>
            {% else %}
                <a class=\"btn btn-primary btn-social pull-right\" title=\"Agregar\" data-toggle=\"tooltip\" disabled>
                    <i class=\"fa fa-plus\"></i> Agregar Nueva Ausencia
                </a>
            {% endif %}
        </h1>
...
{% endblock %}
", "rrhh/ausencias/revisarausencias.twig", "C:\\xampp\\htdocs\\proyectos\\intranietsen\\app\\templates\\rrhh\\ausencias\\revisarausencias.twig");
    }
}
